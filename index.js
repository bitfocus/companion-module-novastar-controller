...
class instance extends instance_skel {
	...
	constructor(system,id,config) {
		...
		this.CHOICES_PRESETS_VX4S = [
			...
			{ id: '5',  label: 'Preset 6',  cmd: new Buffer([0x55,0xAA,0x00,0x2E,0xFE,0x00,0x00,0x00,0x00,0x00,0x01,0x00,0x70,0x00,0x20,0x02,0x01,0x00,0x05,0x81,0x57]) },
			{ id: '6',  label: 'Preset 7',  cmd: new Buffer([0x55,0xAA,0x00,0x2E,0xFE,0x00,0x00,0x00,0x00,0x00,0x01,0x00,0x70,0x00,0x20,0x02,0x01,0x00,0x06,0x82,0x57]) },
			{ id: '7',  label: 'Preset 8',  cmd: new Buffer([0x55,0xAA,0x00,0x2E,0xFE,0x00,0x00,0x00,0x00,0x00,0x01,0x00,0x70,0x00,0x20,0x02,0x01,0x00,0x07,0x83,0x57]) },
			{ id: '8',  label: 'Preset 9',  cmd: new Buffer([0x55,0xAA,0x00,0x2E,0xFE,0x00,0x00,0x00,0x00,0x00,0x01,0x00,0x70,0x00,0x20,0x02,0x01,0x00,0x08,0x84,0x57]) },
			{ id: '9',  label: 'Preset 10', cmd: new Buffer([0x55,0xAA,0x00,0x2E,0xFE,0x00,0x00,0x00,0x00,0x00,0x01,0x00,0x70,0x00,0x20,0x02,0x01,0x00,0x09,0x85,0x57]) }
		];
